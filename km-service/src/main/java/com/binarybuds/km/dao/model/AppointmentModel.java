...
@Entity
@Table(name = "km_appointment")
@Data
public class AppointmentModel {

  @Id
  @GeneratedValue(strategy = GenerationType.IDENTITY)
  @Column(name = "_id_appointment")
  private Integer appointmentId;

  @Column(name = "_id_facility")
  private Integer facilityId;

  @Column(name = "_id_business")
  private Integer businessId;

  @Column(name = "_id_service")
  private Integer serviceId;

  @Column(name = "_id_pet")
  private Integer petId;

  @Column(name = "_nu_appointment_status")
  private String appointmentStatus;

  @Column(name = "_ts_appointment")
  private Timestamp appointmentStart;

  @Column(name = "_ts_created")
