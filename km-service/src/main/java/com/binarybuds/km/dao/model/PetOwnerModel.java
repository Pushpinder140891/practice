...
@Entity
@Table(name = "km_pet_owner")
@Data
public class PetOwnerModel {

  @Id
  @GeneratedValue(strategy = GenerationType.IDENTITY)
  @Column(name = "_id_pet_Owner")
  private Integer petOwnerId;

  @Column(name = "_tx_first_name")
  private String firstName;

  @Column(name = "_tx_last_name")
  private String lastName;

  @Column(name = "_nu_phone_number")
  private Long phoneNumber;

  @Column(name = "_tx_email_address")
  private String emailAddress;

  @Column(name = "_tx_address")
  private String address;

  @Column(name = "_tx_city")
  private String city;

  @Column(name = "_tx_state")
  private String state;

  @Column(name = "_nu_pincode")
  private int pincode;
