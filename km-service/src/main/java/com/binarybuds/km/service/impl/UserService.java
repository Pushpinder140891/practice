...
public class UserService implements IUserService {
  ...
  @Override
  public UserModel updateUser(Integer userId, UserModel userNewData) {

    UserModel existingUser = userDao.findById(userId).orElse(null);
    if (existingUser != null) {
      existingUser.setFirstName(userNewData.getFirstName());
      existingUser.setLastName(userNewData.getLastName());
      existingUser.setEmailAddress(userNewData.getEmailAddress());
      existingUser.setPassword(userNewData.getPassword());
      existingUser.setBusinessId(userNewData.getBusinessId());
  ...
  public List<UserModel> getUsers(Integer businessId) {
    return userDao.getUsers(businessId);
  }
