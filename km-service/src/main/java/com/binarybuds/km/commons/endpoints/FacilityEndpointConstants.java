...
public class FacilityEndpointConstants extends EndpointsConstants {

  public static final String FACILITY = VERSION_1 + "/facility";

  public static final String UPDATE = VERSION_1 + "/facility/update/{facilityId}";
}