...
package com.binarybuds.km.commons.endpoints;

public class UsersEndpointConstants extends EndpointsConstants {

  public static final String GET_APPOINTMENTS_BY_SLOT = VERSION_1 + "/appointments-by-slot";

  public static final String USER = VERSION_1 + "/user";

  public static final String UPDATE_USER = VERSION_1 + "/user/{userId}";

  public static final String GET_USERS = VERSION_1 + "/users";

  public static final String AUTHENTICATE_USER = VERSION_1 + "/authenticate";
