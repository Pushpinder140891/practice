...
package com.binarybuds.km.commons.message.key;

public enum BusinessMessageKey implements IMessageKey {

  BUSINESS_CREATION("BUSINESS.ADDED.SUCCESSFULLY");

  private String businessMessageKey;

  BusinessMessageKey(String businessMessageKey) {
    this.businessMessageKey = businessMessageKey;
  }

  public String getMessageKey() {
    return businessMessageKey;
  }
