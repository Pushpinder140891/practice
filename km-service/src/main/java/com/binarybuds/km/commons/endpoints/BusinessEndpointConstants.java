...
public class BusinessEndpointConstants extends EndpointsConstants {

  public static final String BUSINESS = VERSION_1 + "/business";

  public static final String UPDATE_BUSINESS = VERSION_1 + "/business/{businessId}";

  public static final String DELETE_BUSINESS = VERSION_1 + "/business/{businessId}";
}
