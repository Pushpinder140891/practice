...
public enum ApplicationFormMessageKey implements IMessageKey {

  APPLICATION_FORM_SUBMISSION("APPOINTMENT.ADDED.SUCCESSFULLY");

  private String messageKey;

  ApplicationFormMessageKey(String messageKey) {
