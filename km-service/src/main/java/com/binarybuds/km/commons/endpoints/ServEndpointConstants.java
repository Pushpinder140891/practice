...
public class ServEndpointConstants extends EndpointsConstants {

  public static final String SERVICE = VERSION_1 + "/service";

  public static final String UPDATE_SERVICE = VERSION_1 + "/service/{serviceId}";

  public static final String DELETE_SERVICE = VERSION_1 + "/service/{serviceId}";
}
