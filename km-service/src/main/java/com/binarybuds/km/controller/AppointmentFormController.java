...
import com.binarybuds.km.commons.message.key.ApplicationFormMessageKey;
import com.binarybuds.km.dto.AppointmentForm;
import com.binarybuds.km.dto.Message;
import com.binarybuds.km.service.IAppointmentFormService;
...
public class AppointmentFormController {
  ...
  private final IAppointmentFormService appointmentFormService;

  @PostMapping(path = AppointmentEndpointConstants.SUBMIT_APPOINTMENT)
  public Message submitAppointmentForm(@RequestBody AppointmentForm appointmentForm) {
    appointmentFormService.addAppointment(appointmentForm);
    Message message = new Message();
    message.setMessageKey(ApplicationFormMessageKey.APPLICATION_FORM_SUBMISSION);
    return message;
  }
}
