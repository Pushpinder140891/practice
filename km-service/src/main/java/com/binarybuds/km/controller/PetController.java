...
//  @PostMapping(path = PetEndpointConstants.PET)
//  public PetModel addPet(@RequestBody PetModel petModel) {
//    return null;
//  }
//
//  @GetMapping(path = PetEndpointConstants.PET)
//  public List<PetDto> getPets() {
//    return petService.getPets();
//  }
//
//  @PutMapping(path = PetEndpointConstants.UPDATE_PET)
//  public void updatePet(@PathVariable("petId") Integer petTypeId, @RequestBody PetModel petModel) {
//    petService.updatePet(petTypeId, petModel);
//  }
}