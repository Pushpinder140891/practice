...
import com.binarybuds.km.commons.endpoints.BusinessEndpointConstants;
import com.binarybuds.km.commons.message.key.BusinessMessageKey;
...
public class BusinessController {
  ...
  public final IBusinessService businessService;

  @GetMapping(path = BusinessEndpointConstants.BUSINESS)
  public List<BusinessModel> getBusinesses() {
    return businessService.getBusinesses();
  }

  @PostMapping(path = BusinessEndpointConstants.BUSINESS, consumes = MediaType.APPLICATION_JSON_VALUE)
  public Message addBusiness(@RequestBody BusinessModel businessModel) {
    businessService.addBusiness(businessModel);

    Message message = new Message();
    message.setMessageKey(BusinessMessageKey.BUSINESS_CREATION);
    return message;
  }

  @PutMapping(path = BusinessEndpointConstants.UPDATE_BUSINESS)
  public void updatBusiness(@PathVariable("businessId") Integer businessId,
      @RequestBody BusinessModel businessNewData) {
    businessService.updateBusiness(businessId, businessNewData);
  }

  @DeleteMapping(path = BusinessEndpointConstants.DELETE_BUSINESS)
