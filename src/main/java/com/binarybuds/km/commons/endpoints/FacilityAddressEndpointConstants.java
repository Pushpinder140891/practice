...
public class FacilityAddressEndpointConstants extends EndpointsConstants {

  public static final String FACILITY_ADDRESS = VERSION_1 + "/facility/address";

  public static final String UPDATE_FACILITY_ADDRESS = VERSION_1 + "/facility/address/{facilityAddressId}";

  public static final String DELETE_FACILITY_ADDRESS = VERSION_1 + "/facility/address/{facilityAddressId}";
}
