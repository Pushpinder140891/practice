...
public class CustomerEndpointConstants extends EndpointsConstants {

  public static final String CUSTOMER = VERSION_1 + "/customer";

  public static final String UPDATE_CUSTOMER = VERSION_1 + "/customer/{customerId}";

  public static final String DELETE_CUSTOMER = VERSION_1 + "/customer/{customerId}";
}
