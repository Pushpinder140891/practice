...
public class PetEndpointConstants extends EndpointsConstants {

  public static final String PET = VERSION_1 + "/pet";

  public static final String UPDATE_PET = VERSION_1 + "/pet/{petId}";

  public static final String DELETE_PET = VERSION_1 + "/pet/{petId}";
}
