...
public class CustomerPetEndpointConstants extends EndpointsConstants {

  public static final String CUSTOMER_PET = VERSION_1 + "/customer/pet";

  public static final String UPDATE_CUSTOMER_PET = VERSION_1 + "/customer/pet/{petId}";

  public static final String DELETE_CUSTOMER_PET = VERSION_1 + "/customer/pet/{petId}";
}
