...
public class AppointmentEndpointConstants extends EndpointsConstants {

  public static final String APPOINTMENTS = VERSION_1 + "/appointments";

  public static final String SUBMIT_APPOINTMENT = VERSION_1 + "/appointment/submit";

  public static final String UPDATE_APPOINTMENTS = VERSION_1 + "/appointment/{appointmentId}";

  public static final String DELETE_APPOINTMENTS = VERSION_1 + "/appointment/{appointmentId}";
}
